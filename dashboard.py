...
class IMS:
    def __init__(self, root):
        ...
        # ------------- title --------------
        self.icon_title = PhotoImage(file="d:/study folder/PBL 6th/Inventory-Management-System/images/logo1.png")
        ...
        # ---------------- left menu ---------------
        self.MenuLogo = Image.open("d:/study folder/PBL 6th/Inventory-Management-System/images/menu_im.png")
        ...
        self.icon_side = PhotoImage(file="d:/study folder/PBL 6th/Inventory-Management-System/images/side.png")
        ...
        btn_category = Button(LeftMenu, text="Category", command=self.category, image=self.icon_side, compound=LEFT,
                              padx=5, anchor="w", font=("times new roman", 20, "bold"), bg="white", bd=3,
                              cursor="hand2").pack(side=TOP, fill=X)
        btn_product = Button(LeftMenu, text="Products", command=self.product, image=self.icon_side, compound=LEFT,
                             padx=5, anchor="w", font=("times new roman", 20, "bold"), bg="white", bd=3,
                             cursor="hand2").pack(side=TOP, fill=X)
        btn_sales = Button(LeftMenu, text="Sales", command=self.sales, image=self.icon_side, compound=LEFT, padx=5,
                            anchor="w", font=("times new roman", 20, "bold"), bg="white", bd=3,
                            cursor="hand2").pack(side=TOP, fill=X)
        # Modified Exit Button
        btn_exit = Button(LeftMenu, text="Exit", command=self.exit, image=self.icon_side, compound=LEFT, padx=5,
                           anchor="w", font=("times new roman", 20, "bold"), bg="white", bd=3,
                           cursor="hand2").pack(side=TOP, fill=X)
        ...
        lbl_footer = Label(self.root,
                            text="IMS-Inventory Management System\nFor any Technical Issues Contact: 7879203368",
    ...
    def update_content(self):
        ...
        try:
            ...
            bill = len(os.listdir("d:/study folder/PBL 6th/Inventory-Management-System/bill"))
            ...
            self.lbl_clock.after(200, self.update_content)  # Corrected line
